...
<body class="bg-gray-100 flex h-screen overflow-hidden">
    ...
    <aside id="sidebar"
        ...
        class="sidebar bg-gray-100 text-blue-900 p-4 flex flex-col justify-between fixed h-full shadow-lg z-20 overflow-hidden">
                        ...
                        <ul class="space-y-2 bg-gray-100 p-4 rounded-md shadow-sm">
                            ...
                            <li>
                                <a href="{{ route('admin.dashboard') }}"
                                    class="flex items-center px-4 py-2 rounded-md bg-white hover:bg-blue-100 text-blue-800 transition duration-200 focus:outline-none focus:ring-2 focus:ring-blue-400">
    ...
    <div id="main-content" class="main-content flex-1 flex flex-col min-h-screen relative z-10">
        <header class="bg-white shadow p-4 flex justify-between items-center z-10">
            <div class="flex items-center">
                <button id="sidebar-toggle" class="text-blue-700 hover:text-blue-900 focus:outline-none mr-4 transition">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M4 6h16M4 12h16M4 18h16"></path>
                    </svg>
                </button>
                <h2 class="text-xl font-semibold text-blue-800">@yield('title', 'Dashboard')</h2>
            </div>
        ...
        <footer class="bg-blue-700 text-white p-4 text-center">
            &copy; Website Pembayaran Listrik Pascabayar - Anwar Syadzali Nasution
        </footer>
    </div>
